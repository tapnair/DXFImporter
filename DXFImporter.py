...
# Create our addin definition object
    ...
    my_addin.add_command(
        ...
        SamplePaletteShowCommand,
        {
            ...
            'palette_html_file_url': 'palette_html/DXFImporter.html',
    ...
    # my_addin.add_custom_event("DXFImporter_message_system", SampleCustomEvent1)

    # my_addin.add_document_event("DXFImporter_open_event", app.documentActivated, SampleDocumentEvent1)
    # my_addin.add_document_event("DXFImporter_close_event", app.documentClosed, SampleDocumentEvent2)

    # my_addin.add_workspace_event("DXFImporter_workspace_event", ui.workspaceActivated, SampleWorkspaceEvent1)

    # my_addin.add_web_request_event("DXFImporter_web_request_event", app.openedFromURL, SampleWebRequestOpened)

    # my_addin.add_command_event("DXFImporter_command_event", app.userInterface.commandStarting, SampleCommandEvent)
